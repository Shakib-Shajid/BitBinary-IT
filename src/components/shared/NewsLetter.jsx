...
const NewsLetter = () => {
    return (
        ...
        <div className="flex justify-center mt-16 mb-5" data-aos="zoom-in">
            ...
            <div className="sm:h-[29rem] md:h-96 bg-black rounded-xl text-white text-center pt-8 md:pt-10 lg:pt-16 md:z-10 md:relative md:-mb-40 w-5/6 lg:w-4/5">
                ...
                <div>            
                    ...
                    <div className="md:hidden inline-block">
                        ...
                        <button className="btn py-2 px-9 rounded-full text-white border-0 bg-[#2C2CF2] w-[80%] m-5">Subscribe</button>
                    </div>
