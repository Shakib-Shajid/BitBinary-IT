                    ...
                    <div className="my-5 md:my-5 w-[80%] md:w-[80%] lg:w-full mx-auto space-y-2 md:space-y-0">
                        <form action="">
                            <div className="flex gap-2 md:gap-4 lg:gap-9 flex-col lg:flex-row space-y-2 md:space-y-0 mb-3">
                                <input type="text" placeholder="Your Name*" className="input input-bordered w-full py-3 px-6 rounded-full text-sm h-12" required />
                                <input type="email" placeholder="Your Email*" className="input input-bordered w-full py-3 px-6 rounded-full text-sm h-12" required />
                            </div>
                            <textarea placeholder="Questions" className="textarea md:h-56 lg:h-40 w-full rounded-xl py-3 px-6 text-sm" required ></textarea>
                            ...
                            <div className="flex justify-end">
                                <button className="btn bg-[#2C2CF2] text-white mt-3 md:py-4 md:px-10 rounded-full border-0 w-full">Send Message</button>
                            </div>
                        </form>
